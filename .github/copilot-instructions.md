...
- When a new hands-on lab needs `miniblue` (the Azure simulator), default to the image `ghcr.io/lonegunmanb/miniblue:sha-a05f847` unless a newer pinned tag has been agreed on.
