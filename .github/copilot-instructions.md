...
- When a new hands-on lab needs `miniblue` (the Azure simulator), default to the image `ghcr.io/lonegunmanb/miniblue:sha-39cc27a` unless a newer pinned tag has been agreed on.
