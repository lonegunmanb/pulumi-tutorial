...
- When a new hands-on lab needs `miniblue` (the Azure simulator), default to the image `ghcr.io/lonegunmanb/miniblue:sha-d2af497` unless a newer pinned tag has been agreed on.
