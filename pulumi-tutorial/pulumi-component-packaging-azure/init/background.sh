...
if [ -f /root/pulumi-resource-azure-secure-exec-v0.1.0-linux-amd64.tar.gz ]; then
  tar -xzf /root/pulumi-resource-azure-secure-exec-v0.1.0-linux-amd64.tar.gz -C "$EXEC_WORK/bin"
fi
